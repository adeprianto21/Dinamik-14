...
<body>
    ...
    <div class="body">
        ...
        {{-- <div class="row mt-high">
            <div class="col-md-6">
                <span class="black text-center d-block">Total Pembayaran</span>
                <span class="text-center italic d-block">Total Payment</span>
            </div>
            <div class="col-md-6">
                <span class="black text-center d-block">Metode Pembayaran</span>
                <span class="text-center italic d-block">Payment Method</span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <span class="black text-lg text-center d-block">Rp. 50.000,-</span>
            </div>
            <div class="col-md-6">
                <span class="black text-lg text-center d-block">Transfer Bank</span>
            </div>
        </div> --}}
        <div class="mt-high mb-high">
            <table class="mx-auto">
                ...
                <tr>
                    ...
                    <td class="text-sm bold table-body">x1</td>
                    <td class="text-sm bold table-body">Rp. 50.000</td>
                </tr>
                <tr>
                    <td class="text-sm bold table-header"></td>
                    <td class="text-sm bold table-header">Total</td>
                    <td class="text-sm bold table-header">Rp. 50.000</td>
                </tr>
            </table>
        </div>
    </div>
