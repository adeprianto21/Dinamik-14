...
<body>
    ...
    <div class="body">
        ...
        <div class="mt-high">
            <span class="black text-sm text-center d-block">*Note : Penukaran tiket dilakukan di FPMIPA-C
                UPI pada tanggal :
            </span>
            <span class="black text-sm text-center d-block">
                - 29 November 2019 pukul 09.00 - 15.00
            </span>
            <span class="black text-sm text-center d-block">
                - 30 November 2019 pukul 08.00 - 12.00
            </span>
        </div>
    </div>
